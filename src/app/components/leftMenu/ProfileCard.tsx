    ...
    <>
      <div className="p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6 mb-6">
        <div className="h-20 relative">
          <Image fill src={user.cover || "/noCover.png"} alt="" className="rounded-md object-cover" />
          <Image
            width={48}
            height={48}
          ...
          <div className="flex items-center gap-4">
            <div className="flex">
              <Image
                width={12}
                height={12}
                src="https://images.pexels.com/photos/27555562/pexels-photo-27555562.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
                alt=""
